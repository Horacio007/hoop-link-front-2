...
import { settingsOutline, closeOutline, starOutline, arrowForwardOutline, trashBin, caretDownCircle, funnel, filterCircle, filterCircleOutline } from 'ionicons/icons';
...
//#region Constructor
 constructor(
  ...
  private logger: LoggerService // 🚨 Inyección del LoggerService
    ...
    addIcons({
      settingsOutline, closeOutline, starOutline, arrowForwardOutline, trashBin, caretDownCircle, funnel, filterCircleOutline
    })
